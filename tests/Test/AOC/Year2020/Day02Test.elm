module Test.AOC.Year2020.Day02Test exposing (suite)

import AOC.Year2020.Day02 exposing (part1, part2)
import Expect
...
suite : Test
suite =
    describe "AOC 2020 - Day 02"
        [ test "part 1" <|
            \_ ->
                Expect.equal "640" (part1 (input |> toList))
        , test "part 2" <|
            \_ ->
                Expect.equal "472" (part2 (input |> toList))
        , test "sample part 1" <|
            \_ ->
                Expect.equal "2" (part1 (sample |> toList))
        ]
